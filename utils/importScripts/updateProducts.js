...
const EXCEL_FILE = 'MAIN_PRODUCTS';
const SHEET_INDEX = 0;
const SHEET_LENGTH = 65;

const CAT_INDEX = 'B';
const TITLE_INDEX = 'D';
const HTML_INDEX = 'O';
const OPTION1_INDEX = 'E';
const OPTION2_INDEX = 'F';
const MEDIA_INDEX = 'I';

// Dev Store
// const COLLECTION_ID = 269337034917;

// Live Store
// const COLLECTION_ID = 268744687787;
...
const getProductsFromUrl = async (storeURL, auth) => {
    ...
    var config = {
        method: 'get',
        url: `https://${storeURL}.myshopify.com/admin/api/2021-01/products.json?limit=250&fields=id,title,body_html,product_type,images,variants&vendor=KWL`,
        headers: {
            'Authorization': auth,
